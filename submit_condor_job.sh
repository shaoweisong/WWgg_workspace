...
cp ${3}create_inputfiles_flashggfinalfit_cat12_multiprocessing.py . 
mkdir PBDT_HH_FHSL_combine_2017
mkdir PBDT_HH_FHSL_combine_2017/flashgginput
rm *.root
echo "========================================="
echo "cat create_inputfiles_flashggfinalfit.py"
echo "..."
cat create_inputfiles_flashggfinalfit_cat12_multiprocessing.py
echo "..."
echo "========================================="
python create_inputfiles_flashggfinalfit_cat12_multiprocessing.py --inputFHFiles ${1} --inputBKGFiles ${2}
...
rm create_inputfiles_flashggfinalfit_cat12_multiprocessing.py
